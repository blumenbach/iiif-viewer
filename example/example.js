...
App.prototype._init = function() {
   ...
   [
   {url: 'http://localhost:8888/manifests/stanford.json', label: 'localhost'},
...
App.prototype.openSelectedManifest = function() {
  var self = this;
  ...
  client.get(manifestUrl, function(manifest, response) {
...
App.prototype.cycleViewingModes = function() {
  var newMode;
